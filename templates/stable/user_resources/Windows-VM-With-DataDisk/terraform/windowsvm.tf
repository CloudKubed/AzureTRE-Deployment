...
resource "azurerm_managed_disk" "example" {
  name                 = "data-disk-${local.vm_name}"
  location             = azurerm_windows_virtual_machine.windowsvm.location
  resource_group_name  = azurerm_windows_virtual_machine.windowsvm.resource_group_name
  storage_account_type = "Standard_LRS"
  create_option        = "Empty"
