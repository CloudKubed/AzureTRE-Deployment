...
### Tags ###
variable "custom_tag_key_1" {
  type    = string
  default = ""
}
variable "custom_tag_value_1" {
  type    = string
  default = ""
}
variable "custom_tag_key_2" {
  type    = string
  default = ""
}
variable "custom_tag_value_2" {
  type    = string
  default = ""
}
variable "custom_tag_key_3" {
  type    = string
  default = ""
}
variable "custom_tag_value_3" {
  type    = string
  default = ""
}
